...
rollBtn?.addEventListener("click",async()=>{
  ...
  const roll=Array.from({length:diceCount},secureColour);renderDice(roll);stage.classList.remove("is-rolling");
  const c=makeCode();document.querySelector("#code").textContent=c;document.querySelector("#rollStatus").textContent="Saving verified result…";
